      ...
      <div className="container py-5 my-5">
        <div className="row">
          ...
          <div className="col-md-6 d-flex justify-content-center">
            <img
              src="https://media.istockphoto.com/photos/stack-of-new-books-picture-id1358381788?b=1&k=20&m=1358381788&s=170667a&w=0&h=TqtQpoI8ZUgfiXYp_QEXorAO8b-OmEKaFimecBIMVUs="
              alt="About Us"
              height="400px"
              width="400px"
            />
